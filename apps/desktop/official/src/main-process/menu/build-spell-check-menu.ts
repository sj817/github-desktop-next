...
function getSpellCheckMenuItems(
  ...
  if (misspelledWord) {
    items.push(
      new MenuItem({
        label: t(__DARWIN__ ? 'Add to Dictionary' : 'Add to dictionary'),
        click: () =>
...
export const SpellcheckEnglishLabel = t('Set spellcheck to English')
export const SpellcheckSystemLabel = t('Set spellcheck to system language')
