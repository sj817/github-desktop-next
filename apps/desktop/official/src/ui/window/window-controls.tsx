...
export class WindowControls extends React.Component<{}, IWindowControlState> {
  ...
  private renderButton(
    ...
    // The visible tooltip + aria-label must be localized (the internal `name` is
    // an English identifier, not user-facing copy).
    ...
    const title = titles[name] ?? name[0].toUpperCase() + name.substring(1)
