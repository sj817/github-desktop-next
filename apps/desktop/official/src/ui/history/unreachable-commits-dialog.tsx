...
> {
  ...
  private renderUnreachableCommitsMessage = () => {
    ...
    if (this.state.selectedTab === UnreachableCommitsTab.Unreachable) {
      return (
        <div className="message">
          <Trans i18nKey='unreachable-commits.message-unreachable'>
            You will not see changes from the following {{ commitsPluralized }}{' '}
            because {{ pronounPluralized }} not in the ancestry path of the most
            recent commit in your selection.{' '}
    ...
    return (
      <div className="message">
        <Trans i18nKey='unreachable-commits.message-reachable'>
          You will see changes from the following {{ commitsPluralized }} because{' '}
          {{ pronounPluralized }} in the ancestry path of the most recent commit
          in your selection.{' '}
          <LinkButton uri="https://github.com/desktop/desktop/blob/development/docs/learn-more/unreachable-commits.md">
            Learn more about unreachable commits.
          </LinkButton>
  ...
  public render() {
    return (
      <Dialog
        ...
        title={t(__DARWIN__ ? 'Commit Reachability' : 'Commit reachability')}
