    ...
    return (
      <div className="container">
        <div className="column">
          {this.renderList(release.bugfixes, t('Bugfixes'))}
          {this.renderList(release.enhancements, t('Enhancements'))}
          {this.renderList(release.other, t('Other'))}
        </div>
      </div>
    )
  }
  ...
  private renderPretext = (pretext: ReadonlyArray<ReleaseNote>) => {
    ...
    return (
      <SandboxedMarkdown
        ...
        ariaLabel={t('Release notes generated from markdown')}
      />
    )
  }
    ...
    const dialogHeader = (
      <>
        <span className="version">
          {t('Version {{version}}', { version: latestVersion })}
        </span>
