...
> {
    ...
    return (
      ...
      >
        <div className="filter-popover-header">
          <h3 id="filter-options-header">{t('Filter Options')}</h3>
          <button
            className="close"
        ...
        <div className="filter-options">
          <Checkbox
            ...
            label={t('Included in commit ({{includedFilesCount}})', {
              includedFilesCount,
            })}
          />
          <Checkbox
            ...
            label={t('Excluded from commit ({{excludedFilesCount}})', {
              excludedFilesCount,
            })}
          />
          <Checkbox
            ...
            label={t('New files ({{newFilesCount}})', { newFilesCount })}
          />
          <Checkbox
            value={
            ...
            label={t('Modified files ({{modifiedFilesCount}})', {
              modifiedFilesCount,
            })}
          />
          <Checkbox
            ...
            label={t('Deleted files ({{deletedFilesCount}})', {
              deletedFilesCount,
            })}
          />
        </div>
  ...
  public render() {
    ...
    const buttonTextLabel = hasActiveFilters
      ? t('Filter Options ({{activeFiltersCount}} applied)', {
          activeFiltersCount,
        })
      : t('Filter Options')
