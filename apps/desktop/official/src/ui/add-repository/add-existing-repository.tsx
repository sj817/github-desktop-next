...
> {
  ...
  private buildRepositoryUnsafeError() {
    ...
    const displayedMessage = (
      <>
        <p>
          <Trans i18nKey='add-existing-repository.unsafe-owner'>
            The Git repository
        ...
        <p>
          <Trans i18nKey='add-existing-repository.add-exception'>
  ...
  private buildNotAGitRepositoryError(): IAccessibleMessage | null {
    ...
    const displayedMessage = (
      <>
        <p>
          {t('This directory does not appear to be a Git repository.')}
        </p>
        <p>
          <Trans i18nKey='add-existing-repository.create-here'>
            Would you like to{' '}
  ...
  public render() {
    return (
      <Dialog
        ...
        title={t(
          __DARWIN__ ? 'Add Local Repository' : 'Add local repository'
        )}
