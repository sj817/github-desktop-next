...
> {
  ...
  public render() {
    const buttonLabel = t(__DARWIN__ ? 'Diff Settings' : 'Diff Options')
    return (
  ...
  private renderPopover() {
    const header = t(__DARWIN__ ? 'Diff Settings' : 'Diff Options')
    return (
      <Popover
