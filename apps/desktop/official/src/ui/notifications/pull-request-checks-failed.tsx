...
> {
  ...
  public render() {
    let okButtonTitle = t(
      __DARWIN__ ? 'Switch to Pull Request' : 'Switch to pull request'
    )
      ...
      <div className="ci-check-run-dialog-header">
        ...
        <div className="title-container">
          <div className="summary">
            {failedChecksCount > 1
              ? t('{{count}} checks failed in your pull request', {
                  count: failedChecksCount,
                })
              : t('{{count}} check failed in your pull request', {
                  count: failedChecksCount,
                })}
          </div>
      ...
      <div className="footer-question">
        <span>
          {failedChecks.length > 1
            ...
            : t(
                'Do you want to switch to that Pull Request now and start fixing it?'
              )}
        </span>
      </div>
    )
  ...
  private renderCheckRunStepsLoading(): JSX.Element {
    return (
      <div className="loading-check-runs">
        ...
        <div className="call-to-action">{t('Check run steps incoming!')}</div>
      </div>
    )
  }
