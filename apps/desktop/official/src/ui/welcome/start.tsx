...
export class Start extends React.Component<IStartProps, {}> {
  public render() {
    return (
      <section
        id="start"
        aria-label={t('Welcome to GitHub Desktop')}
        aria-describedby="start-description"
      >
        <div className="start-content">
          <h1 className="welcome-title">
            <Trans i18nKey='start.welcome-title'>
          ...
          <div className="welcome-main-buttons">
            ...
            >
              ...
              {t('Sign in to GitHub.com')}
              <Octicon symbol={octicons.linkExternal} />
            </Button>
            {this.props.loadingBrowserAuth ? (
              <Button onClick={this.cancelBrowserAuth}>{t('Cancel')}</Button>
            ) : (
              <Button onClick={this.signInToEnterprise}>
                {t('Sign in to GitHub Enterprise')}
              </Button>
            )}
          </div>
          <div className="skip-action-container">
            <p className="welcome-text">
              <Trans i18nKey='start.new-to-github'>
                New to GitHub?{' '}
                <LinkButton
        ...
        <div className="start-footer">
          <p>
            <Trans i18nKey='start.terms-and-privacy'>
          ...
          <p>
            <Trans i18nKey='start.usage-metrics'>
