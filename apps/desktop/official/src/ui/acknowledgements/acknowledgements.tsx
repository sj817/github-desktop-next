...
> {
  ...
  private renderLicenses(licenses: Licenses) {
    ...
    for (const [index, key] of Object.keys(licenses).sort().entries()) {
      ...
      if (license.sourceText) {
        ...
        licenseText = t('License: {{license}}', { license: license.license })
      } else {
        licenseText = t('Unknown license')
      }
  ...
  public render() {
    ...
    return (
      <Dialog
        id="acknowledgements"
        title={t('License and Open Source Notices')}
        onSubmit={this.props.onDismissed}
        onDismissed={this.props.onDismissed}
      >
        <DialogContent>
          <p>
            <Trans i18nKey="acknowledgements.intro">
          ...
          <p>{t('GitHub Desktop also distributes these libraries:')}</p>
