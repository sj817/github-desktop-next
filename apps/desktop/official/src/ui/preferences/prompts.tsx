...
> {
  ...
  private renderSwitchBranchOptionLabel = (key: UncommittedChangesStrategy) => {
    switch (key) {
      case UncommittedChangesStrategy.AskForConfirmation:
        return t('Ask me where I want the changes to go')
      case UncommittedChangesStrategy.MoveToNewBranch:
        return t('Always bring my changes to my new branch')
      case UncommittedChangesStrategy.StashOnCurrentBranch:
        return t('Always stash and leave my changes on the current branch')
      default:
    ...
    return (
      <div className="advanced-section">
        <h2 id="switch-branch-heading">
          {t('If I have changes and I switch branches...')}
        </h2>
  ...
  private renderCommittingFilteredChangesPrompt = () => {
    return (
      <Checkbox
        label={t('Committing changes hidden by filter')}
        value={
      ...
      <DialogContent>
        <div className="advanced-section">
          <h2 id="show-confirm-dialog-heading">
            {t('Show a confirmation dialog before...')}
          </h2>
          <div role="group" aria-labelledby="show-confirm-dialog-heading">
            <Checkbox
              label={t('Removing repositories')}
              value={
            ...
            />
            <Checkbox
              label={t('Discarding changes permanently')}
              value={
            ...
            />
            <Checkbox
              label={t('Overriding commit message with generated message')}
              value={
        ...
        <div className="advanced-section">
          <h2>{t('Commit Length')}</h2>
          <Checkbox
            label={t('Show commit length warning')}
            value={
