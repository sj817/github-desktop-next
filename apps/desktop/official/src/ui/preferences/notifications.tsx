      ...
      <DialogContent>
        <div className="advanced-section">
          ...
          <p className="settings-description">
            <Trans i18nKey='notifications.description'>
  ...
  private renderNotificationHint() {
    ...
    if (suggestGrantNotificationPermission) {
      return (
        <>
          {' '}
          <Trans i18nKey='notifications.grant-permission-hint'>
            You need to{' '}
    ...
    if (warnNotificationsDenied) {
      return (
        <div className="setting-hint-warning">
          <Trans i18nKey='notifications.permission-denied-hint'>
    ...
    return (
      <>
        {' '}
        <Trans i18nKey='notifications.make-sure-configured-hint'>
