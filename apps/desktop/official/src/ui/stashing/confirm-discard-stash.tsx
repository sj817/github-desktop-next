...
> {
  ...
  public render() {
    const title = t(__DARWIN__ ? 'Discard Stash?' : 'Discard stash?')
      ...
      >
        <DialogContent>
          <Row id="discard-stash-warning-message">
            {t('Are you sure you want to discard these stashed changes?')}
          </Row>
          <Row>
            <Checkbox
        ...
        <DialogFooter>
          <OkCancelButtonGroup destructive={true} okButtonText={t('Discard')} />
        </DialogFooter>
      </Dialog>
    )
  }
