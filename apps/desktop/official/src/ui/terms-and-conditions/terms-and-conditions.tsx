  ...
  public render() {
    return (
      <Dialog
        ...
        title={t('GitHub Open Source Applications Terms and Conditions')}
      ...
      >
        <DialogContent>
          ...
          <h2>{t('Open Source Licenses and Notices')}</h2>
          ...
          <p>
            <Trans i18nKey='terms-and-conditions.privacy-statement'>
          ...
          <h3>{t('Disclaimers and Limitations of Liability')}</h3>
          ...
          <ol>
            ...
            <li>
              <Trans i18nKey='terms-and-conditions.cc-license'>
