...
> {
  ...
  public render() {
    return (
      <Dialog
        title={t('Are you sure you want to force push?')}
      ...
      >
        <DialogContent>
          <p>
            <Trans i18nKey='confirm-force-push.force-push-warning'>
              A force push will rewrite history on{' '}
              <Ref>{this.props.upstreamBranch}</Ref>. Any collaborators working
              on this branch will need to reset their own local branch to match
        ...
        <DialogFooter>
          <OkCancelButtonGroup destructive={true} okButtonText={t("I'm sure")} />
        </DialogFooter>
      </Dialog>
    )
  }
