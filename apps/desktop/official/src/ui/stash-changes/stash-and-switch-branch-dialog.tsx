...
> {
  ...
  public render() {
    ...
    return (
      <Dialog
        id="stash-changes"
        title={t(__DARWIN__ ? 'Switch Branch' : 'Switch branch')}
      ...
      >
        ...
        <DialogFooter>
          <OkCancelButtonGroup
            okButtonText={t(__DARWIN__ ? 'Switch Branch' : 'Switch branch')}
          />
        </DialogFooter>
      </Dialog>
    )
  ...
  private renderStashOverwriteWarning() {
    ...
    return (
      <Row>
        <Trans i18nKey='stash-and-switch-branch.overwrite-warning'>
  ...
  private renderStashActions() {
    ...
    const items = [
      {
        title: t('Leave my changes on {{name}}', {
          name: this.state.currentBranchName,
        }),
        description: t(
      ...
      {
        title: t('Bring my changes to {{name}}', { name: branchToCheckout.name }),
        description: t(
