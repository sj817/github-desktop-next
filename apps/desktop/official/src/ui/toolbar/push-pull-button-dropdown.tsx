  ...
  private getDropdownItemWithType(type: DropdownItemType): DropdownItem {
    ...
    switch (type) {
      case DropdownItemType.Fetch:
        return {
          title: t('Fetch {{remoteName}}', { remoteName }),
          description: t('Fetch the latest changes from {{remoteName}}', {
            remoteName,
          }),
      ...
      case DropdownItemType.ForcePush: {
        const forcePushWarning = this.props
          ...
          <div className="warning">
            <Trans i18nKey='push-pull-button-dropdown.force-push-warning'>
        ...
        return {
          ...
          description: (
            <>
              <Trans i18nKey='push-pull-button-dropdown.overwrite-changes'>
