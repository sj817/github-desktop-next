  ...
  if (branch.upstream != null) {
    return (
      <Row className="warning-helper-text">
        ...
        <p>
          <Trans i18nKey='branch-name-warnings.tracking-remote'>
            This branch is tracking <Ref>{branch.upstream}</Ref> and renaming
            this branch will not change the branch name on the remote.
          </Trans>
        </p>
      </Row>
    )
...
export function renderBranchNameExistsOnRemoteWarning(
  ...
  return (
    <Row className="warning-helper-text">
      <Octicon symbol={octicons.alert} />
      <p>
        <Trans i18nKey='branch-name-warnings.already-exists-on-remote'>
