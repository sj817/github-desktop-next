...
> {
  ...
  public renderTextBox() {
    return (
      <TextBox
        ...
        autoFocus={true}
        placeholder={this.props.placeholderText || t('Filter')}
  ...
  public renderLiveContainer() {
    ...
    const resultsPluralized = t(n === 1 ? '{{n}} result' : '{{n}} results', { n })
    const postNoResultsMessage =
      itemRows.length === 0 ? this.props.postNoResultsMessage : ''
    const screenReaderMessage = `${resultsPluralized} ${postNoResultsMessage}`
