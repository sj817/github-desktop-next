  ...
  public render() {
    ...
    return (
      ...
      >
        <DialogContent>
          <p>
            <Trans i18nKey='upstream-already-exists.fork-description'>
          ...
          <ul>
            <li>
              <Trans i18nKey='upstream-already-exists.current'>
                Current: <Ref>{existingURL}</Ref>
              </Trans>
            </li>
            <li>
              <Trans i18nKey='upstream-already-exists.expected'>
                Expected: <Ref>{replacementURL}</Ref>
              </Trans>
            </li>
          </ul>
          <p>
            {t('Would you like to update the remote to use the expected URL?')}
          </p>
        </DialogContent>
        <DialogFooter>
          <OkCancelButtonGroup
