...
export class CloneableRepositoryFilterList extends React.PureComponent<ICloneableRepositoryFilterListProps> {
  ...
  public render() {
    ...
    return (
      <SectionFilterList<ICloneableRepositoryListItem>
        ...
        placeholderText={t('Filter your repositories')}
  ...
  private getYourRepositoriesLabel = () => {
    return t(__DARWIN__ ? 'Your Repositories' : 'Your repositories')
  }
  ...
  private renderItem = (
    ...
    return (
      <div className="clone-repository-list-item">
        ...
        {item.archived && <div className="archived">{t('Archived')}</div>}
      </div>
    )
  }

  private renderPostFilter = () => {
    const tooltip = t('Refresh the list of repositories')
  ...
  private renderNoItems = () => {
    ...
    if (loading && (repositories === null || repositories.length === 0)) {
      return (
        <div className="no-items loading">
          {t('Loading repositories from {{endpoint}}…', {
    ...
    return (
      <div className="no-items empty-repository-list">
        <div>
          <Trans i18nKey='cloneable-repository-filter-list.no-repos'>
