...
> {
  ...
  public render() {
    return (
      <Dialog
        title={t('Do you want to fork this repository?')}
...
function renderCreateForkDialogContent(
  ...
  return (
    <>
      <DialogContent>
        <p>
          <Trans i18nKey='create-fork.no-write-access'>
        ...
        <p>
          <Trans i18nKey='create-fork.want-to-fork'>
...
function renderCreateForkDialogError(
  ...
  const suggestion =
    repository.gitHubRepository.htmlURL !== null ? (
      <Trans i18nKey='create-fork.manual-suggestion'>
        {`You can try `}
  ...
  return (
    <>
      <DialogContent>
        <div>
          <Trans i18nKey='create-fork.creation-failed'>
            {`Creating your fork `}
            <strong>
              {`${account.login}/${repository.gitHubRepository.name}`}
            </strong>
