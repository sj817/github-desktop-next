  ...
  public render() {
    ...
    return (
      <Dialog
        ...
        title={t(
          __DARWIN__ ? 'Repository Settings' : 'Repository settings'
        )}
        ...
        <div className="tab-container">
          ...
          >
            ...
            <span>
              ...
              {t(__DARWIN__ ? 'Ignored Files' : 'Ignored files')}
            </span>
            <span>
              <Octicon className="icon" symbol={octicons.gitCommit} />
              {t(__DARWIN__ ? 'Git Config' : 'Git config')}
            </span>
            {showForkSettings && (
              <span>
                <Octicon className="icon" symbol={octicons.repoForked} />
                {t(__DARWIN__ ? 'Fork Behavior' : 'Fork behavior')}
              </span>
            )}
          </TabBar>
  ...
  private onSubmit = async () => {
    ...
    if (this.state.remote && this.props.remote) {
      ...
      if (trimmedUrl !== this.props.remote.url) {
        try {
          ...
          errors.push(t('Failed setting the remote URL: {{error}}', { error: String(e) }))
        }
      }
    }
    ...
    if (this.state.ignoreTextHasChanged && this.state.ignoreText !== null) {
      try {
        ...
        errors.push(t('Failed saving the .gitignore file: {{error}}', { error: String(e) }))
      }
    }
