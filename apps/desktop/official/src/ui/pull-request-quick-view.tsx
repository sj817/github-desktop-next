  ...
  private renderHeader = (): JSX.Element => {
    return (
      <header className="header">
        ...
        <div className="action-needed">{t('Review requested')}</div>
        <Button
  ...
  private renderPRStatus(isDraft: boolean) {
    return (
      <div className={classNames('status', { draft: isDraft })}>
        ...
        />
        <span className="state">{t(isDraft ? 'Draft' : 'Open')}</span>
      </div>
    )
  }
    ...
    return (
      <div className="pull-request">
        ...
        <SandboxedMarkdown
          ...
          ariaLabel={t('Pull request markdown body')}
        />
      </div>
    )
  }
