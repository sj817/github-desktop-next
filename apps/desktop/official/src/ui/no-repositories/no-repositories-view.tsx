...
> {
  ...
  public render() {
    return (
      <UiView id="no-repositories">
        <section aria-label={t("Let's get started!")}>
          <header>
            <h1>{t("Let's get started!")}</h1>
            <p>
              {t('Add a repository to GitHub Desktop to start collaborating')}
            </p>
          </header>
  ...
  private renderCloneSelectedRepositoryButton(
    ...
    return (
      ...
      >
        <Trans i18nKey='no-repositories-view.clone-selected-repository'>
          Clone{' '}
          <strong>
    ...
    return (
      <div className="content-pane">
        ...
        <div className="drag-drop-info">
          ...
          <div>
            <Trans i18nKey='no-repositories-view.protip-drag-drop'>
