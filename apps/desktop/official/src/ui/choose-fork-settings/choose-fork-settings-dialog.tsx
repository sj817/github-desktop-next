...
> {
  ...
  public render() {
    const items = [
      {
        title: t('To contribute to the parent project'),
        description: (
          <Trans i18nKey='choose-fork-settings.contribute-to-parent'>
      ...
      {
        title: t('For my own purposes'),
        description: (
          <Trans i18nKey='choose-fork-settings.contribute-to-self'>
            We will help you contribute to the{' '}
            <strong>
              {{ fullName: this.props.repository.gitHubRepository.fullName }}
            </strong>{' '}
            repository
          </Trans>
        ),
    ...
    return (
      <Dialog
        id="fork-settings"
        title={t('How are you planning to use this fork?')}
      ...
      >
        ...
        <DialogFooter>
          <OkCancelButtonGroup okButtonText={t('Continue')} />
        </DialogFooter>
      </Dialog>
    )
  }
