...
> {
  ...
  public render() {
    ...
    if (!isPathUnsafe) {
      ...
      buttons.push(
        ...
        >
          ...
          {t(__DARWIN__ ? 'Trust Repository' : 'Trust repository')}
        </Button>
      )
    }
    ...
    const repositoryName = this.props.repository.name
      ...
      return (
        <UiView id="missing-repository-view">
          <div className="title-container">
            <div className="title">
              <Trans i18nKey='missing-repository.potentially-unsafe-title'>
                {{ repositoryName }} is potentially unsafe
              </Trans>
            </div>
            <div className="details">
              <p>
                <Trans i18nKey='missing-repository.owned-by-another-user'>
                  The Git repository at <Ref>{unsafePath}</Ref> appears to be
                  owned by another user on your machine. Adding untrusted
                  repositories may automatically execute files in the
                  repository.
                </Trans>
              </p>
              <p>
    ...
    return (
      <UiView id="missing-repository-view">
        <div className="title-container">
          <div className="title">
            <Trans i18nKey='missing-repository.cant-find-repository'>
              Can't find "{{ repositoryName }}"
            </Trans>
          </div>
          <div className="details">
            <Trans i18nKey='missing-repository.last-seen-at'>
              It was last seen at{' '}
